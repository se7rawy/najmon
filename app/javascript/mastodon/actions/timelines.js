...
export const expandAccountTimeline         = (accountId, { maxId, withReplies, withReblogs, tagged } = {}) => expandTimeline(`account:${accountId}${withReplies ? ':with_replies' : ''}${withReblogs ? ':with_reblogs' : ''}${tagged ? `:${tagged}` : ''}`, `/api/v1/accounts/${accountId}/statuses`, { exclude_replies: !withReplies, exclude_reblogs: !withReblogs, tagged, max_id: maxId });
