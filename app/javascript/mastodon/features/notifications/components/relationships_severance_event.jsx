...
export const RelationshipsSeveranceEvent = ({ type, target, followingCount, followersCount, hidden }) => {
  ...
  return (
    <div className='notification-group notification__relationships-severance-event focusable' tabIndex='0'>
      <div className='notification-group__icon'><Icon id='heart_broken' icon={HeartBrokenIcon} /></div>

      <div className='notification-group__main notification__relationships-severance-event__content'>
