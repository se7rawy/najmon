...
export const ModerationWarning: React.FC<Props> = ({ action, id, hidden }) => {
  ...
  return (
    <div className='notification-group notification__moderation-warning focusable' tabIndex='0'>
      <div className='notification-group__icon'><Icon id='warning' icon={GavelIcon} /></div>

      <div className='notification-group__main notification__moderation-warning__content'>
