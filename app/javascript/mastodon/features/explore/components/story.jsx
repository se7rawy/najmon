    ...
    <div className={classNames('story', { expanded })}>
      <div className='story__details'>
        ...
        <div className='story__details__shared'>
          ...
          {typeof sharedTimes === 'number' ? <Link to='/' className='story__details__shared__pill'><ShortNumber value={sharedTimes} renderer={sharesCountRenderer} /></Link> : <Skeleton width='10ch' />}
        </div>
      </div>
