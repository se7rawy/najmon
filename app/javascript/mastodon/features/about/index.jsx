      ...
      <Column bindToDocument={!multiColumn} label={intl.formatMessage(messages.title)}>
        <div className='scrollable about'>
          <div className='about__header'>
            ...
            <p><FormattedMessage id='about.powered_by' defaultMessage='Islamic Social Network ' values={{ najmon: <a href='https://info.najmon.com' className='about__mail' target='_blank'>najmon</a> }} /></p>
          </div>
