...
class Search extends PureComponent {
  ...
  defaultOptions = [
    { label: <><mark>has:</mark> <FormattedList type='disjunction' value={['media']} /></>, action: e => { e.preventDefault(); this._insertText('has:media') } },
    { label: <><mark>is:</mark> <FormattedList type='disjunction' value={['reply']} /></>, action: e => { e.preventDefault(); this._insertText('is:reply') } },
